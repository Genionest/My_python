...
#r2rect = pygame.draw.rect(screen,RED,(150,150,250,120),0) #线宽为0即为完全填充
e1rect = pygame.draw.ellipse(screen,GREEN,(50,50,500,400))
...
alrect = pygame.draw.arc(screen,RED,(200,200,200,100),1.4*pi,1.9*pi,3)
